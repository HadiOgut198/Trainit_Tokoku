<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">OgutApps</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="index.php?halaman=kategori" class="menu-link">
        ...
        <li class="menu-item">
            <a href="index.php?halaman=produk" class="menu-link">
        ...
        <li class="menu-item">
            <a href="index.php?halaman=pembelian" class="menu-link">
        ...
        <li class="menu-item">
            <a href="index.php?halaman=pelanggan" class="menu-link">
        ...
        <li class="menu-item">
            <a href="index.php?halaman=laporan" class="menu-link">
        ...
        <li class="menu-item">
            <a href="index.php?halaman=logout" class="menu-link">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Submenu</span>
        </li>
