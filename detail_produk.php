                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="slider slider-for">
                            <div>
                                <div class="zoom" onmousemove="zoom(event)" style="background-image: url(foto_produk/<?php echo $deatil['foto_produk']; ?>)">
                                    <img src="foto_produk/<?php echo $deatil['foto_produk']; ?>" alt="">
                                </div>
                            </div>
                        ...
                        <div class="slider slider-nav mt-4">
                            <div>
                                <img src="foto_produk/<?php echo $deatil['foto_produk']; ?>" alt="" class="w-100 rounded">
                            </div>
                            <div>
                    ...
                    <div class="col-md-6">
                        <div class="ps-lg-10 mt-6 mt-md-0">
                            <a class="mb-4 d-block"><?php echo $deatil['nama_produk']; ?></a>
                            <h1 class="mb-1"><?php echo $deatil['nama_produk']; ?></h1>
                            <div class="mb-4">
                                ...
                                <a href="#" class="ms-2">(78 reviews)</a>
                            </div>
                            <div class="fs-4">
                                <span class="fw-bold text-dark">Rp<?php echo number_format($deatil['harga_produk']); ?></span>
                                <span class="text-decoration-line-through text-muted">Rp25.000</span>
                                <span><small class="fs-6 ms-2 text-danger">70% Diskon</small></span>
                            </div>
                            <hr class="my-6">
                            <div class="mb-5">
                                <button type="button" class="btn btn-outline-secondary"><?php echo $deatil['berat_produk']; ?>gr</button>
                                <!-- <button type="button" class="btn btn-outline-primary">Tersedia <?php echo $deatil['stok_produk']; ?> stok</button> -->
                                <!-- <button type="button" class="btn btn-outline-secondary">1kgr</button> -->
                            </div>

                            <form method="post">
                                <div>
                                    <div class="input-group input-spinner  ">
                                        <input type="button" value="-" class="button-minus btn btn-sm" data-field="jumlah">
                                        <input type="number" step="1" max="<?php echo $deatil['stok_produk']; ?>" value="1" name="jumlah" class="quantity-field form-control-sm form-input">
                                        <input type="button" value="+" class="button-plus btn btn-sm " data-field="jumlah">
                                    </div>
                                </div>
                                <div class="mt-3 row justify-content-start g-2 align-items-center">
                                    <div class="col-xxl-4 col-lg-4 col-md-5 col-5 d-grid">
                                        <button name="beli" class="btn btn-primary">
                                            <i class="feather-icon icon-shopping-cart me-2"></i>Beli Sekarang
                                        </button>
                                    </div>
                            ...
                            if (isset($_POST['beli'])) {
                                // Mendapatkan jumlah produk yang dibeli
                                $jumlah = $_POST['jumlah'];
                            ...
                            <div>
                                <table class="table table-borderless mb-0">
                                    <tbody>
                                        <tr>
                                            <td>Product ID:</td>
                                            <td>OGT<?php echo $deatil['id_produk']; ?></td>
                                        </tr>
                                        <tr>
                                            <td>Stok:</td>
                                            <td class="text-primary"><?php echo $deatil['stok_produk']; ?> tersedia</td>
                                        </tr>
                                        <tr>
                                            <td>Berat:</td>
                                            <td><?php echo $deatil['berat_produk']; ?>gr</td>
                                        </tr>
                                        <tr>
                                            <td>Type:</td>
                                            <td>Fashion</td>
                                        ...
                                        <tr>
                                            <td>Shipping:</td>
                                            <td><small>Gratis pengiriman.<span class="text-muted">( Penjemputan gratis hari ini )</span></small></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-pills nav-lb-tab" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="product-tab" data-bs-toggle="tab" data-bs-target="#product-tab-pane" type="button" role="tab" aria-controls="product-tab-pane" aria-selected="true">Deskripsi Produk</button>
                            </li>
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="sellerInfo-tab" data-bs-toggle="tab" data-bs-target="#sellerInfo-tab-pane" type="button" role="tab" aria-controls="sellerInfo-tab-pane" aria-selected="false" disabled>Seller Info</button>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="product-tab-pane" role="tabpanel" aria-labelledby="product-tab" tabindex="0">
                                <div class="my-8">
                                    <div class="mb-5">
                                        <h4 class="mb-1"><?php echo $deatil['nama_produk']; ?></h4>
                                        <p class="mb-0">
                                            <?php echo $deatil['deskripsi_produk'] ?>
                                            ...
                                            sagittis sed. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                        </p>
                                    </div>
                                </div>
                            </div>
