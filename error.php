                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class=" mb-6 mb-lg-0">
                                    ...
                                    <!-- btn -->
                                    <a href="index.php" class="btn btn-danger"><i class="bi bi-arrow-left-circle me-1"></i>Kembali</a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div>
...
<!-- Mirrored from freshcart.codescandy.com/pages/404error.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Mar 2023 17:38:06 GMT -->
